    ...
    return ListView(
      ...
      children: <Widget>[
        Container(
            ...
            child: Image.asset("images/ardi.jpeg")),
        Text("NAMA    : Mohammad Nuzula Syafrial Ardi", style: ukuran),
        Text("TTL     : Sidoarjo, 1 Desember 2001", style: ukuran),
        Text("NIPP    : 20.20.04099", style: ukuran),
        Text(
            ...
            onPressed: () {
              showDialog(
                  ...
                  builder: (BuildContext context) => AlertDialog(
                        ...
                        content: const Text("WELCOME Ardi"),
                        actions: <Widget>[
                          TextButton(
